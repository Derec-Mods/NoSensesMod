...
public class HeadphoneModel extends EntityModel<PlayerEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData headband = root.addChild("headband", ModelPartBuilder.create()
                .uv(18, 5).cuboid(-5.05F, -2.0F, -2.0F, 1.0F, 4.0F, 4.0F, new Dilation(0.0F))
                .uv(18, 13).cuboid(4.05F, -2.0F, -2.0F, 1.0F, 4.0F, 4.0F, new Dilation(0.0F))
                .uv(2, 0).cuboid(-5.05F, -3.0F, -2.0F, 10.1F, 1.0F, 4.0F, new Dilation(0.0F)),
                ModelTransform.pivot(0.0F, -8.0F, 0.0F));
        headband.addChild("earcups", ModelPartBuilder.create()
                .uv(0, 5).cuboid(4.05F, 2.0F, -3.0F, 3.0F, 6.0F, 6.0F, new Dilation(0.0F))
                .uv(0, 17).cuboid(-7.05F, 2.0F, -3.0F, 3.0F, 6.0F, 6.0F, new Dilation(0.0F)),
